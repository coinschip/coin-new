<template>
	<jet-form-section @submitted="createCoinInformation">
        ...
        <template #form>
			...
			<!-- Launch Date -->
            <div class="col-span-6 sm:col-span-2">
                <jet-label for="launched" value="Launch Date" />
                <jet-input id="launched" type="date" class="mt-1 block w-full" v-model="form.launched" />
                <jet-input-error :message="form.errors.launched" class="mt-2" />
            </div>
